...
def calculate_all_nvm(num_resolvers=2):
    with open( "%s/1_occurrence.ptmp"%DATA_DIRECTORY,"wb") as firstfile:
        pickle.dump(set(),firstfile)
    cumulative_count=["%s/1_occurrence.ptmp"%DATA_DIRECTORY]
